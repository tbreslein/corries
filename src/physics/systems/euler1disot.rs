...
impl<const S: usize> Physics for Euler1DIsot<S> {
    ...
    fn update_derived_values(&mut self) {
        ...
        update_flux(self.flux.view_mut(), self.prim.view(), self.cons.view(), self.c_sound.view());
    }
...
#[inline(always)]
pub fn update_flux(mut flux: ArrayViewMut2<f64>, prim: ArrayView2<f64>, cons: ArrayView2<f64>, c_sound: ArrayView1<f64>) {
